...
const NewsLetter = () => {
  return (
    <div className='bg-black pt-16 pb-16 flex items-center justify-center w-full flex-col'>
        ...
        <h1 className='text-lg sm:text-xl md:text-2xl text-white font-semibold mt-10 tracking-widest'>Your Travel Jopurney Starts Here</h1>
        <p className='mt-3 text-white text-xs sm:text-sm'>Sign Up and We will send the best deals to you
        </p>
